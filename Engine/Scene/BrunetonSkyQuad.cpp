...
//    CSun::~CSun()
//    {
//      m_pDataPool->RemoveMonitor(this);
...
//    }
//
//    GXHRESULT CSun::RegisterIdentify(GXLPVOID pIndentify)
//    {
//      return GX_FAIL;
//    }
//
//    GXHRESULT CSun::UnregisterIdentify(GXLPVOID pIndentify)
//    {
//      return GX_FAIL;
//    }
//
...
//    }
//
//    GXHRESULT CAtmosphere::RegisterIdentify(GXLPVOID pIndentify)
//    {
//      return GX_FAIL;
//    }
//
//    GXHRESULT CAtmosphere::UnregisterIdentify(GXLPVOID pIndentify)
//    {
//      return GX_FAIL;
//    }
//
...
//  } // namespace Internal
  ...
  //CFloat3& BrunetonSkyQuad::GetDirection()
  //{
  //  return m_Sun.GetDirection();
  //}

  //float BrunetonSkyQuad::GetIntensity()
  //{
  //  return m_Sun.GetIntensity();
  //}

  //CFloat3& BrunetonSkyQuad::GetColor()
  //{
  //  return m_Sun.GetColor();
  //}

  //CFloat3& BrunetonSkyQuad::GetBetaRay()
  //{
  //  return m_Atmosphere.GetBetaRay();
  //}

  //CFloat3& BrunetonSkyQuad::GetBetaRayTheta()
  //{
  //  return m_Atmosphere.GetBetaRayTheta();
  //}

  //CFloat3& BrunetonSkyQuad::GetBetaMie()
  //{
  //  return m_Atmosphere.GetBetaMie();
  //}

  //CFloat3& BrunetonSkyQuad::GetBetaMieTheta()
  //{
  //  return m_Atmosphere.GetBetaMieTheta();
  //}

  //float BrunetonSkyQuad::GetDirectionalityFactor()
  //{
  //  return m_Atmosphere.GetDirectionalityFactor();
  //}
  BrunetonSkyQuad::BrunetonSkyQuad()
  {
  }
  ...
  GXHRESULT BrunetonSkyQuad::Create(GXGraphics* pGraphics, BrunetonSkyQuad** ppSkyQuad)
  {
    GXHRESULT hval = GX_OK;
    BrunetonSkyQuad* pSky = new BrunetonSkyQuad;
    ...
    //if(GXSUCCEEDED(hval))
    //{
    //  hval = MODataPool::CreateFromCode(&pSky->m_pDataPool, 
    //    "AtmosphereScatteringPool", Internal::s_szDataPoolDecl);
    //  if(GXSUCCEEDED(hval))
    //  {
    ...
    //  pSky->m_Sun.SetTurbidity(2.0f);

    //  pSky->m_Atmosphere.SetDirectionalityFactor(0.6f);
    //  pSky->m_Atmosphere.SetTurbidity(2.0f);
    //  pSky->m_Atmosphere.SetMieFactor(0.31f);
    //  pSky->m_Atmosphere.SetRayFactor(1040.0f);
    //}

    if(GXSUCCEEDED(hval))
    {
      GXMaterialInst* pSkyMtl = NULL;
      hval = pGraphics->CreateMaterialFromFileW(&pSkyMtl, L"Shaders\\Bruneton_Sky.txt", MLT_REFERENCE);
      if(GXSUCCEEDED(hval))
      {
