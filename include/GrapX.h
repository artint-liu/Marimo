...
enum GXTextureRatio
{
  ...
  TEXSIZE_OKTA        = (GXUINT)-(TEXSIZE_FIXEDPOINT >> 3),    // 1/8 屏幕, 长(宽)
  TEXSIZE_QUARTER     = (GXUINT)-(TEXSIZE_FIXEDPOINT >> 2),    // 1/4 屏幕, 长(宽)
  TEXSIZE_HALF        = (GXUINT)-(TEXSIZE_FIXEDPOINT >> 1),    // 1/2 屏幕, 长(宽)
  TEXSIZE_SAME        = (GXUINT)-TEXSIZE_FIXEDPOINT,        // 一倍 屏幕, 长(宽)
  TEXSIZE_DOUBLE      = (GXUINT)-(TEXSIZE_FIXEDPOINT << 1),    // 两 屏幕, 长(宽)
  TEXSIZE_QUAD        = (GXUINT)-(TEXSIZE_FIXEDPOINT << 2),    // 四倍 屏幕, 长(宽)
  TEXSIZE_OCTUPLE     = (GXUINT)-(TEXSIZE_FIXEDPOINT << 3),    // 八倍 屏幕, 长(宽)
};
