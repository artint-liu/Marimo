...
#define GXCLEAR_DEPTHSTENCIL  (GXCLEAR_DEPTH|GXCLEAR_STENCIL)
#define GXCLEAR_ALL           (GXCLEAR_TARGET|GXCLEAR_DEPTH|GXCLEAR_STENCIL)
...
struct STOCKOBJECT
{
  ...
  GrapX::Texture* pTextureWhite8x8;
  GrapX::Texture* pTextureBlack8x8;
  GXFont*   pDefaultFont;
};
