...
namespace GXUIEXT
{
  namespace PropertySheet
  {
    ...
    public:
      ...
      GXBOOL          Initialize        (const GXLPVOID* pBasePtrList, const PROPSHEET_DATALINK* pDataLink);
      GXVOID          Release           ();

      GXBOOL          UploadData        (const GXLPVOID* pBasePtrList, const PROPSHEET_DATALINK* pDataLink, GXINT nIDFirst, GXINT nIDLast);
      GXBOOL          DownloadData      (const GXLPVOID* pBasePtrList, const PROPSHEET_DATALINK* pDataLink, GXINT nIDFirst, GXINT nIDLast);
    ...
    private:
      ...
      static GXINT                GetMaxPtrIndex      (const PROPSHEET_DATALINK* pDataLayout);
    ...
    public:
      ...
      GXBOOL    UpdateData    (const PROPSHEET_DATALINK* pDataLink);
