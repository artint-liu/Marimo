...
//static GXLRESULT HEADER_SendNotify(GXHWND hwnd, GXUINT code, NMHDR *hdr);
//static GXLRESULT HEADER_SendCtrlCustomDraw(GXHWND hwnd, GXDWORD dwDrawStage, HDC hdc, const GXRECT *rect);
//
...
//
//static GXINT
//HEADER_OrderToIndex(GXHWND hwnd, WPARAM wParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
...
//
//static GXINT
//HEADER_DrawItem (GXHWND hwnd, HDC hdc, GXINT iItem, GXBOOL bHotTrack, GXLRESULT lCDFlags)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
...
//            if (phdi->bDown) {
//                gxDrawEdge (hdc, &r, BDR_RAISEDOUTER,
//                            BF_RECT | BF_FLAT | BF_MIDDLE | BF_ADJUST);
//            }
//            else
//                gxDrawEdge (hdc, &r, EDGE_RAISED,
//                            BF_RECT | BF_SOFT | BF_MIDDLE | BF_ADJUST);
//        }
//        else
//            gxDrawEdge (hdc, &r, EDGE_ETCHED, BF_BOTTOM | BF_RIGHT | BF_ADJUST);
//
...
//	dis.CtlID      = gxGetWindowLongPtrW (hwnd, GWLP_ID);
//	dis.itemID     = iItem;
...
//	gxSendMessageW (infoPtr->hwndNotify, WM_DRAWITEM,
//			(WPARAM)dis.CtlID, (GXLPARAM)&dis);
...
//	        BitBlt (hClipDC, bx, r.top + ((GXINT)rh - bmp.bmHeight) / 2, 
...
//
//static void
//HEADER_DrawHotDivider(GXHWND hwnd, HDC hdc)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
//    HBRUSH brush;
//    GXRECT r;
...
//    brush = gxCreateSolidBrush(GetSysColor(COLOR_HIGHLIGHT));
//    gxFillRect(hdc, &r, brush);
//    gxDeleteObject(brush);
//}
//
//static void
//HEADER_Refresh (GXHWND hwnd, HDC hdc)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
...
//        else {
//            if (GetWindowLongW (hwnd, GWL_STYLE) & HDS_BUTTONS)
//                gxDrawEdge (hdc, &rcRest, EDGE_RAISED, BF_TOP|BF_LEFT|BF_BOTTOM|BF_SOFT|BF_MIDDLE);
//            else
//                gxDrawEdge (hdc, &rcRest, EDGE_ETCHED, BF_BOTTOM|BF_MIDDLE);
//        }
//    }
//    
...
//
//static void
//HEADER_DrawTrackLine (GXHWND hwnd, HDC hdc, GXINT x)
//{
//    GXRECT rect;
//    HPEN hOldPen;
//    GXINT  oldRop;
...
//    const GXHDITEMW *src, GXBOOL fSourceUnicode, LPVOID *ppvScratch)
//{
//    *ppvScratch = NULL;
//    *dest = *src;
//    
...
//
//static GXLRESULT
//HEADER_SendNotify(GXHWND hwnd, GXUINT code, NMHDR *nmhdr)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
//
//    nmhdr->hwndFrom = hwnd;
//    nmhdr->idFrom   = gxGetWindowLongPtrW (hwnd, GWLP_ID);
//    nmhdr->code     = code;
//
//    return gxSendMessageW(infoPtr->hwndNotify, WM_NOTIFY,
...
//
//static GXLRESULT
//HEADER_SendCtrlCustomDraw(GXHWND hwnd, GXDWORD dwDrawStage, HDC hdc, const GXRECT *rect)
//{
//    GXNMCUSTOMDRAW nm;
...
//    nmhdr.pitem = lpItem;
//
//    return (GXBOOL)HEADER_SendNotify(hwnd, code, (NMHDR *)&nmhdr);
//}
//
//static GXBOOL
...
//    dispInfo.hdr.idFrom   = gxGetWindowLongPtrW (hwnd, GWLP_ID);
//    if (infoPtr->nNotifyFormat == NFR_UNICODE)
//    {
...
//    gxSendMessageW(infoPtr->hwndNotify, WM_NOTIFY, dispInfo.hdr.idFrom, (GXLPARAM)&dispInfo);
//
...
//
//static GXLRESULT
//HEADER_CreateDragImage (GXHWND hwnd, WPARAM wParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr(hwnd);
//    HEADER_ITEM *lpItem;
//    GXHIMAGELIST himl;
...
//
//static GXLRESULT
//HEADER_SetHotDivider(GXHWND hwnd, WPARAM wParam, GXLPARAM lParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr(hwnd);
//    GXINT iDivider;
//    GXRECT r;
...
//        GXPOINT pt;
//        GXUINT flags;
//        pt.x = (GXINT)(SHORT)LOWORD(lParam);
//        pt.y = 0;
...
//
//static GXLRESULT
//HEADER_DeleteItem (GXHWND hwnd, WPARAM wParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr(hwnd);
...
//
//static GXLRESULT
//HEADER_GetItemT (GXHWND hwnd, GXINT nItem, LPHDITEMW phdi, GXBOOL bUnicode)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
//    HEADER_ITEM *lpItem;
//    GXUINT mask;
...
//
//static GXLRESULT
//HEADER_GetItemRect (GXHWND hwnd, WPARAM wParam, GXLPARAM lParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
//    GXINT iItem = (GXINT)wParam;
...
//
//static GXLRESULT
//HEADER_GetOrderArray(GXHWND hwnd, WPARAM wParam, GXLPARAM lParam)
//{
...
//
//static GXLRESULT
//HEADER_SetOrderArray(GXHWND hwnd, WPARAM wParam, GXLPARAM lParam)
//{
//    int i;
//    LPINT order = (LPINT) lParam;
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
...
//
//static GXLRESULT
//HEADER_SetBitmapMargin(GXHWND hwnd, WPARAM wParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
...
//
//static inline GXLRESULT
//HEADER_SetUnicodeFormat (GXHWND hwnd, WPARAM wParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
//    GXBOOL bTemp = (infoPtr->nNotifyFormat == NFR_UNICODE);
//
//    infoPtr->nNotifyFormat = ((GXBOOL)wParam ? NFR_UNICODE : NFR_ANSI);
//
//    return bTemp;
//}
//
...
//    infoPtr->order = 0;
//    infoPtr->bRectsValid = FALSE;
//    infoPtr->hcurArrow = LoadCursorW (0, (GXLPWSTR)IDC_ARROW);
...
//	gxSendMessageW (infoPtr->hwndNotify, WM_NOTIFYFORMAT, (WPARAM)hwnd, NF_QUERY);
//
//    hdc = GetDC (0);
...
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
//    GXDWORD dwStyle = GetWindowLongW (hwnd, GWL_STYLE);
//    GXPOINT pt;
//    GXUINT  flags;
//    GXINT   nItem;
//    HDC   hdc;
...
//
//    pt.x = (GXINT)(SHORT)LOWORD(lParam);
//    pt.y = (GXINT)(SHORT)HIWORD(lParam);
//    HEADER_InternalHitTest (hwnd, &pt, &flags, &nItem);
//
//    if (infoPtr->bPressed) {
//	if (infoPtr->bDragging)
...
//
//static GXLRESULT
//HEADER_NotifyFormat (GXHWND hwnd, WPARAM wParam, GXLPARAM lParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
//
//    switch (lParam)
...
//	case NF_REQUERY:
//	    infoPtr->nNotifyFormat =
//		gxSendMessageW ((GXHWND)wParam, WM_NOTIFYFORMAT,
//			      (WPARAM)hwnd, (GXLPARAM)NF_QUERY);
//	    return infoPtr->nNotifyFormat;
//    }
//
//    return 0;
...
//
//static GXLRESULT
//HEADER_Paint (GXHWND hwnd, WPARAM wParam)
//{
//    HDC hdc;
//    PAINTSTRUCT ps;
//
...
//    gxSendMessageW( hwnd, WM_CONTEXTMENU, (WPARAM) hwnd, MAKELPARAM(pt.x, pt.y));
//
//    return bRet;
//}
//
...
//
//static GXLRESULT
//HEADER_SetFont (GXHWND hwnd, WPARAM wParam, GXLPARAM lParam)
//{
//    HEADER_INFO *infoPtr = HEADER_GetInfoPtr (hwnd);
//    TEXTMETRICW tm;
//    GXHFONT hFont, hOldFont;
...
//}
//
//static GXLRESULT HEADER_SetRedraw(GXHWND hwnd, WPARAM wParam, GXLPARAM lParam)
//{
...
//
//
//static GXLRESULT WINAPI
//HEADER_WindowProc (GXHWND hwnd, GXUINT msg, WPARAM wParam, GXLPARAM lParam)
//{
...
//	case HDM_GETITEMA:
//	case HDM_GETITEMW:
//	    return HEADER_GetItemT (hwnd, (GXINT)wParam, (LPHDITEMW)lParam, msg == HDM_GETITEMW);
//
...
//	    return HEADER_InsertItemT (hwnd, (GXINT)wParam, (LPHDITEMW)lParam, msg == HDM_INSERTITEMW);
//
//	case HDM_LAYOUT:
...
//	case HDM_SETITEMA:
//	case HDM_SETITEMW:
//	    return HEADER_SetItemT (hwnd, (GXINT)wParam, (LPHDITEMW)lParam, msg == HDM_SETITEMW);
//
...
//    wndClass.hCursor       = LoadCursorW (0, (GXLPWSTR)IDC_ARROW);
