...
namespace GrapX
{
  ...
  GXMaterialInstImpl::GXMaterialInstImpl(GrapX::Graphics* pGraphics)
    : GXMaterialInst()
  ...
  GrapX::Graphics* GXMaterialInstImpl::GetGraphicsUnsafe()
  {
    return m_pGraphics;
  }
  ...
  GXHRESULT GXMaterialInstImpl::LoadFileW(GrapX::Graphics* pGraphics, GXLPCWSTR szFilename)
  {
    SmartRepository Storage;
  ...
  GXHRESULT GXMaterialInstImpl::LoadRepository(GrapX::Graphics* pGraphics, SmartRepository* pStorage)
  {
    CLBREAK;
    return GX_FAIL;
  }
